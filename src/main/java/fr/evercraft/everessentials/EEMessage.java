...
public class EEMessage extends EMessage<EverEssentials> {
	...
	public enum EEMessages implements EnumMessage {
		...
		PERMISSIONS_COMMANDS_AFK_EXECUTE("permissionsCommandsAfkExecute", ""),
		PERMISSIONS_COMMANDS_AFK_OTHERS("permissionsCommandsAfkOthers", ""),
		PERMISSIONS_COMMANDS_AFK_BYPASS_AUTO("permissionsCommandsAfkBypassAuto", ""),
		PERMISSIONS_COMMANDS_AFK_BYPASS_KICK("permissionsCommandsAfkBypassKick", ""),
		PERMISSIONS_COMMANDS_BACK_EXECUTE("permissionsCommandsBackExecute", ""),
		PERMISSIONS_COMMANDS_BED_EXECUTE("permissionsCommandsBedExecute", ""),
		PERMISSIONS_COMMANDS_BED_OTHERS("permissionsCommandsBedOthers", ""),
		PERMISSIONS_COMMANDS_BOOK_EXECUTE("permissionsCommandsBookExecute", ""),
		PERMISSIONS_COMMANDS_BROADCAST_EXECUTE("permissionsCommandsBroadCastExecute", ""),
		PERMISSIONS_COMMANDS_BUTCHER_EXECUTE("permissionsCommandsButcherExecute", ""),
		PERMISSIONS_COMMANDS_BUTCHER_ANIMAL("permissionsCommandsButcherAnimal", ""),
		PERMISSIONS_COMMANDS_BUTCHER_MONSTER("permissionsCommandsButcherMonster", ""),
		PERMISSIONS_COMMANDS_BUTCHER_TYPE("permissionsCommandsButcherType", ""),
		PERMISSIONS_COMMANDS_BUTCHER_ALL("permissionsCommandsButcherAll", ""),
		PERMISSIONS_COMMANDS_BUTCHER_WORLD("permissionsCommandsButcherWorld", ""),
		PERMISSIONS_COMMANDS_CLEAREFFECT_EXECUTE("permissionsCommandsCleareffectExecute", ""),
		PERMISSIONS_COMMANDS_CLEAREFFECT_OTHERS("permissionsCommandsCleareffectOthers", ""),
		PERMISSIONS_COMMANDS_CLEARINVENTORY_EXECUTE("permissionsCommandsClearinventoryExecute", ""),
		PERMISSIONS_COMMANDS_CLEARINVENTORY_OTHERS("permissionsCommandsClearinventoryOthers", ""),
		PERMISSIONS_COMMANDS_COLOR_EXECUTE("permissionsCommandsColorExecute", ""),
		PERMISSIONS_COMMANDS_EFFECT_EXECUTE("permissionsCommandsEffectExecute", ""),
		PERMISSIONS_COMMANDS_ENCHANT_EXECUTE("permissionsCommandsEnchantExecute", ""),
		PERMISSIONS_COMMANDS_ENDERCHEST_EXECUTE("permissionsCommandsEnderchestExecute", ""),
		PERMISSIONS_COMMANDS_ENDERCHEST_OTHERS("permissionsCommandsEnderchestOthers", ""),
		PERMISSIONS_COMMANDS_EXP_EXECUTE("permissionsCommandsExpExecute", ""),
		PERMISSIONS_COMMANDS_EXP_OTHERS("permissionsCommandsExpOthers", ""),
		PERMISSIONS_COMMANDS_EXT_EXECUTE("permissionsCommandsExtExecute", ""),
		PERMISSIONS_COMMANDS_EXT_OTHERS("permissionsCommandsExtOthers", ""),
		PERMISSIONS_COMMANDS_FEED_EXECUTE("permissionsCommandsFeedExecute", ""),
		PERMISSIONS_COMMANDS_FEED_OTHERS("permissionsCommandsFeedOthers", ""),
		PERMISSIONS_COMMANDS_FORMAT_EXECUTE("permissionsCommandsFormatExecute", ""),
		PERMISSIONS_COMMANDS_FREEZE_EXECUTE("permissionsCommandsFreezeExecute", ""),
		PERMISSIONS_COMMANDS_FREEZE_OTHERS("permissionsCommandsFreezeOthers", ""),
		PERMISSIONS_COMMANDS_FLY_EXECUTE("permissionsCommandsFlyExecute", ""),
		PERMISSIONS_COMMANDS_FLY_OTHERS("permissionsCommandsFlyOthers", ""),
		PERMISSIONS_COMMANDS_GAMEMODE_EXECUTE("permissionsCommandsGamemodeExecute", ""),
		PERMISSIONS_COMMANDS_GAMEMODE_OTHERS("permissionsCommandsGamemodeOthers", ""),
		PERMISSIONS_COMMANDS_GENERATE_EXECUTE("permissionsCommandsGenerateExecute", ""),
		PERMISSIONS_COMMANDS_GETPOS_EXECUTE("permissionsCommandsGetposExecute", ""),
		PERMISSIONS_COMMANDS_GETPOS_OTHERS("permissionsCommandsgGetposOthers", ""),
		PERMISSIONS_COMMANDS_GOD_EXECUTE("permissionsCommandsGodExecute", ""),
		PERMISSIONS_COMMANDS_GOD_OTHERS("permissionsCommandsGodOthers", ""),
		PERMISSIONS_COMMANDS_HAT_EXECUTE("permissionsCommandsHatExecute", ""),
		PERMISSIONS_COMMANDS_HEAL_EXECUTE("permissionsCommandsHealExecute", ""),
		PERMISSIONS_COMMANDS_HEAL_OTHERS("permissionsCommandsHealOthers", ""),
		PERMISSIONS_COMMANDS_HOME_EXECUTE("permissionsCommandsHomeExecute", ""),
		PERMISSIONS_COMMANDS_DELHOME_EXECUTE("permissionsCommandsDelhomeExecute", ""),
		PERMISSIONS_COMMANDS_HOMEOTHERS_EXECUTE("permissionsCommandsHomeothersExecute", ""),
		PERMISSIONS_COMMANDS_HOMEOTHERS_DELETE("permissionsCommandsHomeothersDelete", ""),
		PERMISSIONS_COMMANDS_SETHOME_EXECUTE("permissionsCommandsSethomeExecute", ""),
		PERMISSIONS_COMMANDS_SETHOME_MULTIPLE_EXECUTE("permissionsCommandsSethomeMultipleExecute", ""),
		PERMISSIONS_COMMANDS_SETHOME_MULTIPLES("permissionsCommandsSethomeMultiples", ""),
		PERMISSIONS_COMMANDS_SETHOME_MULTIPLE_UNLIMITED("permissionsCommandsSethomeMultipleUnlimited", ""),
		PERMISSIONS_COMMANDS_IGNORE_EXECUTE("permissionsCommandsIgnoreExecute", ""),
		PERMISSIONS_COMMANDS_IGNORE_OTHERS("permissionsCommandsIgnoreOthers", ""),
		PERMISSIONS_COMMANDS_IGNORE_BYPASS("permissionsCommandsIgnoreBypass", ""),
		PERMISSIONS_COMMANDS_INVSEE_EXECUTE("permissionsCommandsInvseeExecute", ""),
		PERMISSIONS_COMMANDS_INVSEE_MODIFY("permissionsCommandsInvseeExecute", ""),
		PERMISSIONS_COMMANDS_INFO_EXECUTE("permissionsCommandsInfoExecute", ""),
		PERMISSIONS_COMMANDS_ITEM_EXECUTE("permissionsCommandsItemExecute", ""),
		PERMISSIONS_COMMANDS_ITEM_BYPASS("permissionsCommandsItemBypass", ""),
		PERMISSIONS_COMMANDS_ITEMNAME_EXECUTE("permissionsCommandsItemnameExecute", ""),
		PERMISSIONS_COMMANDS_ITEMLORE_EXECUTE("permissionsCommandsItemloreExecute", ""),
		PERMISSIONS_COMMANDS_JUMP_EXECUTE("permissionsCommandsJumpExecute", ""),
		PERMISSIONS_COMMANDS_KICK_EXECUTE("permissionsCommandsKickExecute", ""),
		PERMISSIONS_COMMANDS_KICK_BYPASS("permissionsCommandsKickBypass", ""),
		PERMISSIONS_COMMANDS_KICKALL_EXECUTE("permissionsCommandsKickallExecute", ""),
		PERMISSIONS_COMMANDS_KILL_EXECUTE("permissionsCommandsKillExecute", ""),
		PERMISSIONS_COMMANDS_LAG_EXECUTE("permissionsCommandsLagExecute", ""),
		PERMISSIONS_COMMANDS_LIST_EXECUTE("permissionsCommandsListExecute", ""),
		PERMISSIONS_COMMANDS_REPAIR_EXECUTE("permissionsCommandsRepairExecute", ""),
		PERMISSIONS_COMMANDS_REPAIR_HAND("permissionsCommandsRepairHand", ""),
		PERMISSIONS_COMMANDS_REPAIR_HOTBAR("permissionsCommandsRepairHotbar", ""),
		PERMISSIONS_COMMANDS_REPAIR_ALL("permissionsCommandsRepairAll", ""),
		PERMISSIONS_COMMANDS_REPLY_EXECUTE("permissionsCommandsReply", ""),
		PERMISSIONS_COMMANDS_MAIL_EXECUTE("permissionsCommandsMailExecute", ""),
		PERMISSIONS_COMMANDS_MAIL_SEND("permissionsCommandsMailSend", ""),
		PERMISSIONS_COMMANDS_MAIL_SENDALL("permissionsCommandsMailSendall", ""),
		PERMISSIONS_COMMANDS_ME_EXECUTE("permissionsCommandsMeExecute", ""),
		PERMISSIONS_COMMANDS_MSG_EXECUTE("permissionsCommandsMsgExecute", ""),
		PERMISSIONS_COMMANDS_MSG_COLOR("permissionsCommandsMsgFormat", ""),
		PERMISSIONS_COMMANDS_MSG_FORMAT("permissionsCommandsMsgFormat", ""),
		PERMISSIONS_COMMANDS_MSG_MAGIC("permissionsCommandsMsgMagic", ""),
		PERMISSIONS_COMMANDS_MSG_CHARACTER("permissionsCommandsMsgCharacter", ""),
		PERMISSIONS_COMMANDS_MSG_COMMAND("permissionsCommandsMsgCommand", ""),
		PERMISSIONS_COMMANDS_MSG_URL("permissionsCommandsMsgUrl", ""),
		PERMISSIONS_COMMANDS_MSG_ICONS("permissionsCommandsMsgIcons", ""),
		PERMISSIONS_COMMANDS_MOJANG_EXECUTE("permissionsCommandsMojangExecute", ""),
		PERMISSIONS_COMMANDS_MORE_EXECUTE("permissionsCommandsMoreExecute", ""),
		PERMISSIONS_COMMANDS_MORE_UNLIMITED("permissionsCommandsMoreUnlimited", ""),
		PERMISSIONS_COMMANDS_MOTD_EXECUTE("permissionsCommandsMotdExecute", ""),
		PERMISSIONS_COMMANDS_NAMES_EXECUTE("permissionsCommandsNamesExecute", ""),
		PERMISSIONS_COMMANDS_NAMES_OTHERS("permissionsCommandsNamesOthers", ""),
		PERMISSIONS_COMMANDS_NEAR_EXECUTE("permissionsCommandsNearExecute", ""),
		PERMISSIONS_COMMANDS_NEARS("permissionsCommandsNears", ""),
		PERMISSIONS_COMMANDS_PING_EXECUTE("permissionsCommandsPingExecute", ""),
		PERMISSIONS_COMMANDS_PING_OTHERS("permissionsCommandsPingOthers", ""),
		PERMISSIONS_COMMANDS_PLAYED_EXECUTE("permissionsCommandsPlayedExecute", ""),
		PERMISSIONS_COMMANDS_PLAYED_OTHERS("permissionsCommandsPlayedOthers", ""),
		PERMISSIONS_COMMANDS_RULES_EXECUTE("permissionsCommandsRulesExecute", ""),
		PERMISSIONS_COMMANDS_SAY_EXECUTE("permissionsCommandsSayExecute", ""),
		PERMISSIONS_COMMANDS_SEEN_EXECUTE("permissionsCommandsSeenExecute", ""),
		PERMISSIONS_COMMANDS_SKULL_EXECUTE("permissionsCommandsSkullExecute", ""),
		PERMISSIONS_COMMANDS_SKULL_OTHERS("permissionsCommandsSkullOthers", ""),
		PERMISSIONS_COMMANDS_SPAWN_EXECUTE("permissionsCommandsSpawnExecute", ""),
		PERMISSIONS_COMMANDS_SPAWNS_EXECUTE("permissionsCommandsSpawnsExecute", ""),
		PERMISSIONS_COMMANDS_SETSPAWN_EXECUTE("permissionsCommandsSetspawnExecute", ""),
		PERMISSIONS_COMMANDS_DELSPAWN_EXECUTE("permissionsCommandsDelspawnExecute", ""),
		PERMISSIONS_COMMANDS_SPAWNER_EXECUTE("permissionsCommandsSpawnerExecute", ""),
		PERMISSIONS_COMMANDS_SPAWNMOB_EXECUTE("permissionsCommandsSpawnmobExecute", ""),
		PERMISSIONS_COMMANDS_SPEED_EXECUTE("permissionsCommandsSpeedExecute", ""),
		PERMISSIONS_COMMANDS_SPEED_FLY("permissionsCommandsSpeedFly", ""),
		PERMISSIONS_COMMANDS_SPEED_WALK("permissionsCommandsSpeedWalk", ""),
		PERMISSIONS_COMMANDS_SPEED_OTHERS("permissionsCommandsSpeedOthers", ""),
		PERMISSIONS_COMMANDS_STOP_EXECUTE("permissionsCommandsStopExecute", ""),
		PERMISSIONS_COMMANDS_SUDO_EXECUTE("permissionsCommandsSudoExecute", ""),
		PERMISSIONS_COMMANDS_SUDO_CONSOLE("permissionsCommandsSudoConsole", ""),
		PERMISSIONS_COMMANDS_SUDO_BYPASS("permissionsCommandsSudoBypass", ""),
		PERMISSIONS_COMMANDS_SUICIDE_EXECUTE("permissionsCommandsSuicideExecute", ""),
		PERMISSIONS_COMMANDS_TP_EXECUTE("permissionsCommandsTpExecute", ""),
		PERMISSIONS_COMMANDS_TP_OTHERS("permissionsCommandsTpOthers", ""),
		PERMISSIONS_COMMANDS_TPACCEPT_EXECUTE("permissionsCommandsTpacceptExecute", ""),
		PERMISSIONS_COMMANDS_TPADENY_EXECUTE("permissionsCommandsTpadenyExecute", ""),
		PERMISSIONS_COMMANDS_TPA_EXECUTE("permissionsCommandsTpaExecute", ""),
		PERMISSIONS_COMMANDS_TPAHERE_EXECUTE("permissionsCommandsTpahereExecute", ""),
		PERMISSIONS_COMMANDS_TPAALL_EXECUTE("permissionsCommandsTpaallExecute", ""),
		PERMISSIONS_COMMANDS_TPAALL_OTHERS("permissionsCommandsTpaallOthers", ""),
		PERMISSIONS_COMMANDS_TPALL_EXECUTE("permissionsCommandsTpallExecute", ""),
		PERMISSIONS_COMMANDS_TPALL_OTHERS("permissionsCommandsTpallOthers", ""),
		PERMISSIONS_COMMANDS_TPPOS_EXECUTE("permissionsCommandsTpposExecute", ""),
		PERMISSIONS_COMMANDS_TPPOS_OTHERS("permissionsCommandsTpposOthers", ""),
		PERMISSIONS_COMMANDS_TIME_EXECUTE("permissionsCommandsTime", ""),
		PERMISSIONS_TELEPORT_BYPASS_TIME("permissionsTeleportBypassTime", ""),
		PERMISSIONS_TELEPORT_BYPASS_MOVE("permissionsTeleportBypass", ""),
		PERMISSIONS_COMMANDS_TOGGLE_EXECUTE("permissionsCommandsToggleExecute", ""),
		PERMISSIONS_COMMANDS_TOOGLE_OTHERS("permissionsCommandsToogleOthers", ""),
		PERMISSIONS_COMMANDS_TOP_EXECUTE("permissionsCommandsTopExecute", ""),
		PERMISSIONS_COMMANDS_TPHERE_EXECUTE("permissionsCommandsTphereExecute", ""),
		PERMISSIONS_COMMANDS_TREE_EXECUTE("permissionsCommandsTreeExecute", ""),
		PERMISSIONS_COMMANDS_UUID_EXECUTE("permissionsCommandsUuidExecute", ""),
		PERMISSIONS_COMMANDS_UUID_OTHERS("permissionsCommandsUuidOthers", ""),
		PERMISSIONS_COMMANDS_VANISH_EXECUTE("permissionsCommandsVanishExecute", ""),
		PERMISSIONS_COMMANDS_VANISH_OTHERS("permissionsCommandsVanishOthers", ""),
		PERMISSIONS_COMMANDS_VANISH_SEE("permissionsCommandsVanishSee", ""),
		PERMISSIONS_COMMANDS_VANISH_PVP("permissionsCommandsVanishPvp", ""),
		PERMISSIONS_COMMANDS_VANISH_INTERACT("permissionsCommandsVanishInteract", ""),
		PERMISSIONS_COMMANDS_WARP_EXECUTE("permissionsCommandsWarpExecute", ""),
		PERMISSIONS_COMMANDS_WARPS("permissionsCommandsWarps", ""),
		PERMISSIONS_COMMANDS_WARP_OTHERS("permissionsCommandsWarpOthers", ""),
		PERMISSIONS_COMMANDS_DELWARP_EXECUTE("permissionsCommandsDelwarpExecute", ""),
		PERMISSIONS_COMMANDS_SETWARP_EXECUTE("permissionsCommandsSetwarpExecute", ""),
		PERMISSIONS_COMMANDS_WEATHER_EXECUTE("permissionsCommandsWeatherExecute", ""),
		PERMISSIONS_COMMANDS_WHITELIST_EXECUTE("permissionsCommandsWhiteListExecute", ""),
		PERMISSIONS_COMMANDS_WHITELIST_MANAGE("permissionsCommandsWhitelistManage", ""),
		PERMISSIONS_COMMANDS_WORLDBORDER_EXECUTE("permissionsCommandsWorldboderExecute", ""),
		PERMISSIONS_COMMANDS_WORLDS_EXECUTE("permissionsCommandsWorldsExecute", ""),
		PERMISSIONS_COMMANDS_WORLDS_OTHERS("permissionsCommandsWorldsOthers", ""),
		PERMISSIONS_COMMANDS_WHOIS_EXECUTE("permissionsCommandsWhoisExecute", ""),
		PERMISSIONS_COMMANDS_WHOIS_OTHERS("permissionsCommandsWhoisOthers", "");
