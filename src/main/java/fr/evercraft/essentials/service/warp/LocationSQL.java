...
public class LocationSQL{
	...
	public LocationSQL(final EverEssentials plugin, final String world, final double x, final double y, final double z, final double yaw, final double pitch) {
		this.plugin = plugin;
	 ...
	 */
	public LocationSQL(final EverEssentials plugin, final Transform<World> transform) {
	 ...
	 * @throws ServerDisableException 
	 */
	public LocationSQL(final EverEssentials plugin, final Location<World> location) {
		this(plugin, location, null);
	}
	
	public LocationSQL(final EverEssentials plugin, final Location<World> location, final Vector3d rotation) {
