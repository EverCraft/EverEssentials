...
public class EEMessage extends EMessage {
	...
	public enum EEMessages implements EnumMessage {
		...
		TPA_STAFF_QUESTION("tpa.staffQuestion", "&7Votre demande a bien été envoyé à &6<player>&7."),
		TPA_STAFF_ACCEPT("tpa.staffAccept", "&7Votre demande de téléportation a bien été accepté par &6<player>&7."),
		TPA_STAFF_DENY("tpa.staffDeny", "&7Votre demande de téléportation a été refusé par &6<player>&7."),
		TPA_STAFF_EXPIRE("tpa.staffExpire", "&7Votre demande de téléportation à &6<player> vient d'expirer&7."),
		...
		TPA_PLAYER_EXPIRE("tpa.playerExpire", "&cLa demande de téléportation de &6<player> &ca expiré."),
		...
		TPA_ERROR_EQUALS("tpa.errorEquals", "&cImpossible de vous envoyez une demande à vous même."),
		...
		TPAHERE_STAFF_QUESTION("tpahere.staffQuestion", "&7Votre demande a bien été envoyé à &6<player>&7."),
		TPAHERE_STAFF_ACCEPT("tpahere.staffAccept", "&7Votre demande de téléportation a bien été accepté par &6<player>&7."),
		TPAHERE_STAFF_DENY("tpahere.staffDeny", "&7Votre demande de téléportation a été refusé par &6<player>&7."),
		TPAHERE_STAFF_EXPIRE("tpahere.staffExpire", "&7Votre demande de téléportation à &6<player> vient d'expirer&7."),
		...
		TPAHERE_PLAYER_QUESTION_ACCEPT_HOVER("tpahere.playerQuestionAcceptHover", "&cCliquez ici pour vous téléportez à &6<player>&c."),
		...
		TPAHERE_ERROR_EQUALS("tpahere.errorEquals", "&cImpossible de vous envoyez une demande à vous même."),
