...
public class EEMessage extends EMessage {
	...
	public enum EEMessages implements EnumMessage {
		...
		TPA_STAFF_DELAY("tpa.staffDelay", "&7Votre demande de téléportation à &6<player> vient d'expirer&7."),
		...
		TPA_PLAYER_ACCEPT("tpa.playerAccept", "&2&l&nAccepter"),
		TPA_PLAYER_ACCEPT_HOVER("tpa.playerAcceptHover", "&cCliquez ici pour accepter la téléportation de &6<player>&c."),
		TPA_PLAYER_DENY("tpa.playerDeny", "&2&l&nRefuser"),
		TPA_PLAYER_DENY_HOVER("tpa.playerDenyHover", "&cCliquez ici pour refuser la téléportation de &6<player>&7."),
		TPA_PLAYER_DELAY("tpa.playerDelay", "&cLa demande de téléportation de &6<player> &ca expiré."),
		TPA_PLAYER_EMPTY("tpa.playerEmpty", "&cVous n'avez aucune demande de téléportation de &6<player>&c."),
		TPA_PLAYER_EMPTY_ALL("tpa.playerEmptyAll", "&cVous n'avez aucune demande de téléportation."),
