...
public class EEMessage extends EMessage {
	...
	public enum EEMessages implements EnumMessage {
		...
		WHITELIST_ADD_ERROR("whitelist.add.player", "&cErreur : Le joueur <player> est déjà dans la whitelist."),
		...
		WHITELIST_REMOVE_ERROR("whitelist.remove.player", "&cErreur : Le joueur <player> n'est pas dans la whitelist."),
