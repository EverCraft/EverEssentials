...
public class EEMessage extends EMessage {
	...
	public enum EEMessages implements EnumMessage {
		...
		KILL_PLAYER_DEATH_MESSAGE("kill.playerDeathMessage", "&f< " + EChat.DISPLAYNAME_FORMAT + "> c'est tué par <staff>."),
		KILL_PLAYER_CANCEL("kill.playerCancel", "&cImpossible de tué &6<player>&c."),
		KILL_STAFF("kill.staff", "&7Vous avez tué &6<player>&7."),
		KILL_EQUALS("kill.equals", "&7Vous vous êtes suicidé."),
		KILL_EQUALS_DEATH_MESSAGE("kill.equalsDeathMessage", "&f< " + EChat.DISPLAYNAME_FORMAT + "> c'est suicidé."),
		KILL_EQUALS_CANCEL("kill.equalsCancel", "&cImpossible de vous suicidé."),
		...
		WORLDBORDER_ADD_BORDER("worldborder.add.border", "&7La taille de la bordure du monde &6<world> &7a été défini à &6<amount> &7bloc(s) de large."),
		WORLDBORDER_ADD_BORDER_INCREASE("worldborder.add.borderIncrease", "&7Agrandissement de la bordure du monde &6<world> &7à <amount> bloc(s) de large en &6<time> &7seconde(s)."),
		WORLDBORDER_ADD_BORDER_DECREASE("worldborder.add.borderDecrease", "&7Rétrécissement de la bordure du monde &6<world> &7à <amount> bloc(s) de large en &6<time> &7seconde(s)."),
