 ...
 * along with EverEssentials.  If not, see <http://wwwGnuOrg/licenses/>.
 */
...
public class EEMessage extends EMessage<EverEssentials> {
	...
	public enum EEMessages implements EnumMessage {
		...
		GENERATE_WARNING_VALID("generateWarningConfirmationValid", 				"&2&nConfirmer"),
		...
		DELHOME_CONFIRMATION_VALID("delhomeConfirmationValid", 					"&2&nConfirmer"),
		...
		HOMEOTHERS_LIST_TELEPORT("homeOthersListTeleport", 						"&a&nTéléporter"),
		...
		HOMEOTHERS_LIST_DELETE("homeOthersListDelete", 							"&c&nSupprimer"),
		...
		HOMEOTHERS_DELETEE_CONFIRMATION_VALID("homeOthersDeleteConfirmationValid", 			"&2&nConfirmer"),
		...
		IGNORE_LIST_REMOVE("ignoreListRemove", 						"&a&nSupprimer"),
		...
		LAG_WORLDS_WORLD("lagWorldsWorld", 							"        &6&l●  &6{world}"),
		...
		MAIL_DELETE_VALID("mailDeleteValid",	 					"&a&nConfirmer"),
		...
		MAIL_BUTTON_READ("mailButtonRead", 							"&a&nLire"),
		MAIL_BUTTON_READ_HOVER("mailButtonReadHover", 				"&cCliquez ici pour lire le message."),
		MAIL_BUTTON_DELETE("mailButtonDelete", 						"&c&nSupprimer"),
		...
		MAIL_BUTTON_NEW_MESSAGE("mailButtonNewMessage", 			"&2&nCliquez ici."),
		...
		SPAWN_ERROR_SET("spawnErrorSet", 											"&cIl y a aucun spawn défini pour le groupe &6{name}."),
		...
		DELSPAWN_CONFIRMATION_VALID("delspawnConfirmationValid", 					"&2&nConfirmer"),
		DELSPAWN_CONFIRMATION_VALID_HOVER("delspawnConfirmationValidHover", 		"&cCliquez ici pour supprimer le spawn &6{spawn}&c."),
		...
		TPA_PLAYER_QUESTION_ACCEPT("tpaPlayerQuestionAccept", 						"&2&l&nAccepter"),
		TPA_PLAYER_QUESTION_ACCEPT_HOVER("tpaPlayerQuestionAcceptHover", 			"&cCliquez ici pour accepter la téléportation de &6{player}&c."),
		TPA_PLAYER_QUESTION_DENY("tpaPlayerQuestionDeny", 							"&4&l&nRefuser"),
		...
		TPAHERE_PLAYER_QUESTION("tpaherePlayerQuestion", 							"&6{player} &7souhaite que vous vous téléportiez à lui/elle : {accept} {deny}[RT]"
																				  + "&7Cette demande de téléportation expira dans &6{delay}&7."),
		TPAHERE_PLAYER_QUESTION_ACCEPT("tpaherePlayerQuestionAccept", 				"&2&l&nSe téléporter"),
		TPAHERE_PLAYER_QUESTION_ACCEPT_HOVER("tpaherePlayerQuestionAcceptHover", 	"&cCliquez ici pour vous téléporter à &6{player}&c."),
		TPAHERE_PLAYER_QUESTION_DENY("tpaherePlayerQuestionDeny", 					"&4&l&nRefuser"),
		...
		DELWARP_CONFIRMATION_VALID("delwarpConfirmationValid", 						"&2&nConfirmer"),
		...
		WHITELIST_LIST_REMOVE("whitelistListRemove", "&a&nSupprimer"),
		...
		WORLDS_LIST_TELEPORT("worldsListTeleport", "&2&nTéléporter"),
