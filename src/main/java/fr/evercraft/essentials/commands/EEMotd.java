...
public class EEMotd extends ECommand<EverEssentials> {
	...
	public boolean testPermission(final CommandSource source) {
		return source.hasPermission(this.plugin.getPermissions().get("MOTD"));
	}

	public Text description(final CommandSource source) {
		return this.plugin.getMessages().getText("MOTD_DESCRIPTION");
	}

	public Text help(final CommandSource source) {
		return Text.builder("/motd").onClick(TextActions.suggestCommand("/motd "))
